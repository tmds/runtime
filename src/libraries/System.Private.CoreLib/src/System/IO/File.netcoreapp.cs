...
namespace System.IO
{
    public static partial class File
    {
        ...
        /// <exception cref="T:System.IO.IOException">An I/O error, such as specifying <see cref="FileMode.CreateNew" /> when the file specified by <paramref name="path" /> already exists, occurred.</exception>
        ...
        {
            Strategies.FileStreamHelpers.ValidateArguments(path, mode, access, share, bufferSize: 0, options);

            return SafeFileHandle.Open(Path.GetFullPath(path), mode, access, share, options);
        }
